...
<body>
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form action="{{ route('search') }}" method="GET" class="d-flex me-3">
                        <input class="form-control me-2" type="search" name="search" placeholder="{{ __('Search news...') }}" aria-label="Search" value="{{ request('search') }}">
        ...
        <footer class="bg-dark text-white text-center py-3 mt-5">
            <div class="container">
                <p class="mb-0">&copy; {{ date('Y') }} {{ config('app.name', 'NewsApp') }}. All rights reserved.</p>
            </div>
        </footer>
    </div>
